...
def read_match_event(match_event_id: uuid.UUID, db: database_dependency):
...
def add_match_event(match_event: MatchEventCreate, db: database_dependency):
...
def remove_match_event(match_event_id: uuid.UUID, db: database_dependency):
